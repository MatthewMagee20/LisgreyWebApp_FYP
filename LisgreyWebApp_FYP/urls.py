...
urlpatterns = [
    ...
    path('privacy/', TemplateView.as_view(template_name='policies/privacy_policy.html'), name='privacy'),
    path('cookies/', TemplateView.as_view(template_name='policies/cookie_policy.html'), name='cookies'),
